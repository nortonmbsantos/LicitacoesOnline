...
<div class="center-block site">
    ...
    <form action="<?= URL_RAIZ . 'user/bid/delete/' . $bidding->getId() ?>" method="post" onsubmit="return confirm('Tem certeza que deseja excluir seu lance? Deixará de participar desta licitação.');">
